...
const PREFIX_PAREMETERS_ADD = ADD_USER_PAGE . '?' . ACTION_TYPE . '=' . ACTION_ADD;
const PREFIX_PAREMETERS_EDIT = ADD_USER_PAGE . '?' . ACTION_TYPE . '=' . ACTION_EDIT . '&' . ITEM_ID . '=';
const PREFIX_PAREMETERS_DEL = ADD_USER_PAGE . '?' . ACTION_TYPE . '=' . ACTION_DEL . '&' . ITEM_ID . '=';
const PREFIX_PAREMETERS_VIEW_ALL = USER_LIST_PAGE . '?' . ACTION_TYPE . '=' . ACTION_VIEW_ALL;
...
?>
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i><a href="<?php echo PREFIX_PAREMETERS_VIEW_ALL; ?>">View All User</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <a href="<?php echo PREFIX_PAREMETERS_ADD; ?>" class="confirm-delete btn mini red-stripe" role="button" data-title="johnny" data-id="1">Add New User</a>
                    </div>
                    <div class="col-lg-12">
