...
const PREFIX_PAREMETERS_VIEW_ALL = SECTION_LIST_PAGE . '?' . ACTION_TYPE . '=' . ACTION_VIEW_ALL;
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i><a href="<?php echo PREFIX_PAREMETERS_VIEW_ALL; ?>">View All Section</a>
                            </li>
                        </ol>
                    </div>
                </div>
